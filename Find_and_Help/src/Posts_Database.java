...
public class Posts_Database {
     ...
     public String posts="";
		public boolean get_posts()
		{
			...
			catch(Exception e) {System.out.println("----------file 2not2 found----------");}
			return false;
		}
		public void save_post(String post,String Username,String date)
		{
			try {
				...
				Class.forName("net.ucanaccess.jdbc.UcanaccessDriver");
				connect=DriverManager.getConnection("jdbc:ucanaccess://accounts_database.accdb");
				command=connect.prepareStatement("insert into posts_database (posts,username,post_date) values ('"+post+"','"+Username+"','"+date+"')");
				command.execute();
